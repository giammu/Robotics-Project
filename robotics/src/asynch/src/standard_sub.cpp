...
void callbackTalker1(const std_msgs::String::ConstPtr &msg)
{
    ...
    ros::Duration(2.0).sleep();     //mettiamo la sleep per simulare il fatto che la computazione richiede 2 secondi
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Subscriber counter1_sub = nh.subscribe("talker1", 1, callbackTalker1); //standard subscriber
